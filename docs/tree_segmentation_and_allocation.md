...
Để reproduce/so sánh với các phương án gốc, có thể đổi objective mà không đổi
...
Ví dụ chạy GEAR-tree với objective gốc TreePO:
...
Ví dụ chạy objective gốc TreeRL:
