...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-root", default="hf_data", type=Path, help="Raw save_to_disk root.")
    parser.add_argument("--output-root", default="data", type=Path, help="VERL parquet output root.")
