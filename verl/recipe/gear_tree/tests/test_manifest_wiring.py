"""PLAN.md P0.N8: manifest lifecycle helpers wired by RayGearTreeTrainer.
...
def test_manifest_persists_across_json_round_trip(tmp_path):
    ...
    assert loaded.policy_aggregation == POLICY_AGGREGATION_VDRA
    assert loaded.node_balanced_invariants_passed is True
    assert loaded.extras["actor_loss_mode"] == "vdra_node_balanced_ppo"
