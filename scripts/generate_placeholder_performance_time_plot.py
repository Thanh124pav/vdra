...
def main() -> None:
    ...
    fig.suptitle("Pass@1 Across Training Time", fontsize=20, fontweight="bold", y=0.985)
    fig.supxlabel("Time (hours)", fontsize=14, fontweight="bold", y=0.045)
    ...
    fig.savefig(out_dir / "pass1_time_spotree_airi_placeholder.png", dpi=300, bbox_inches="tight")
    fig.savefig(out_dir / "pass1_time_spotree_airi_placeholder.pdf", bbox_inches="tight")
